...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //업로드하려면 외부저장소 권한이 필요! 동적 퍼미션 코드 필요
            ...
            case 10:
                if(resultCode==RESULT_OK){
                    ...
                    if(imgUri!=null) {
                        ...
                        //업로드를 하려면 이미지의 절대경로(실제경로 예)file://storage/emulated/0/Download/aaa.png)가 필요함!
                        //Uri -> 절대경로(실제경로) 로 변환
                        imgPath=getRealPathFromUri(imgUri);

                        //이미지 경로 Uri와 실제경로 확인해보기
    ...
    public void clickUpload(View view) {
        ...
        String serverUrl="http://boxoun.dothome.co.kr/Android/insertDB.php";

        //Volley plus Library를 이용해서 파일전송하도록..
        //Vollet+는 AndroidStudio 에서 검색이 안됌..[google검색 이용]

        //파일전송요청 객체 생성[결과를 String 으로 받음]
