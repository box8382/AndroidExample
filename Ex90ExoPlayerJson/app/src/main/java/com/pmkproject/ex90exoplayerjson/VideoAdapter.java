...
public class VideoAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        vh.tvSubTitle.setText(item.getSubTitle());
        vh.tvDesc.setText(item.getDesc());

        //실행할 비디오데이터 소스객체 생성(CD or LP), 미디어팩토리로 부터....
        ProgressiveMediaSource mediaSource=mediaFactory.createMediaSource(Uri.parse(item.getVideoUrl()));
    ...
    class VH extends RecyclerView.ViewHolder{
        ...
        public VH(@NonNull View itemView) {
            ...
            //1. context, 2. 플레이어 재생 뒤로가기 같은걸 가지고있는 default 기본설정
