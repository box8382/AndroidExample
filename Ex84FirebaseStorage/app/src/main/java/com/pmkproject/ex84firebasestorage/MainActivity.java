package com.pmkproject.ex84firebasestorage;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickLoad(View view) {
        ...
        StorageReference imgRef=rootRef.child("map.jpg");
        //하위 폴더가 있다면 폴더명까지 포함하여 쓰면 됨
        imgRef=rootRef.child("photo/battle3.gif");
        if(imgRef!=null){
            // 참조 객체로 부터 이미지의 다운로드 URL을 얻어오기
    ...
    public void clickUpload(View view) {
        ...
        String filename=sdf.format(new Date())+".png"; //현재시간 지정
        //원래 확장자는 파일의 실제 확장자를 얻어와서 사용해야 함.. 그려려면 이미지의 절대주소를 구원해야함
        ...
        //업로드한 파일의 경로를 firebaseDB에 저장하면 게시판같은 앱도 구현할 수 있음.
